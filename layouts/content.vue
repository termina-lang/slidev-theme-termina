...
.t-mdcol :deep(li)::before { content: ""; position: absolute; left: 0; top: 12px; width: 18px; height: 18px; border-radius: 5px; background: var(--t-accent); }
...
.t-mdcol :deep(li li)::before { width: 12px; height: 12px; top: 11px; background: color-mix(in srgb, var(--t-accent) 45%, white); }
</style>
