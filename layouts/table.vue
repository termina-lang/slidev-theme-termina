...
<style scoped>
.t-mdtbl :deep(table) { width: 100%; border-collapse: collapse; margin-top: 46px; font-size: 26px; }
.t-mdtbl :deep(th), .t-mdtbl :deep(td) { text-align: center; padding: 20px 22px; border-bottom: 1px solid var(--t-hair); }
...
.t-tblnote { margin-top: 28px; font-size: 24px; line-height: 1.5; color: var(--t-muted); }
