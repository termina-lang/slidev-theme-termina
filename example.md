...
layout: cover
eyebrow: Sample · v0
lead: A fictional deck that shows every layout in the theme.
# coverImage / logos are per-deck assets (drop them in this deck's public/):
# coverImage: /cover.png
# logos:
#   - { src: /sponsor_a_white.png, h: 62 }
---

# slidev-theme-termina — Example Deck

<!--
HOW THIS DECK WORKS
- Each slide is `---` + a frontmatter block that picks a `layout:`.
- Text layouts take plain Markdown; data layouts take a `:data` object.
...
items:
  ...
  - { title: 'Tables & data', meta: 'gantt · wbs' }
...
layout: section
number: '02'
lead: Tables and the data-driven schedule diagrams.
---
